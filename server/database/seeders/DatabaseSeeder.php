...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $adminPermissions = [
            ...
            'view_support', 'edit_support', 'changeStatus_support', 'delete_support',
            'view_comment', 'add_comment', 'delete_comment', 'show_comment', 'edit_comment',
            'view_banners', 'add_banners', 'delete_banners',
        ];
        $managerPermissions = [
            'view_user', 'add_user',
